                          ...
                          <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                            <div class="">
                                  <div class="mb-4">
                                      ...
                                      <jet-input-error :message="$page.errors.title" class="mt-2" />
                                  ...
                                  <div class="mb-4">
                                      ...
                                      <textarea class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="exampleFormControlInput2" v-model="form.content" placeholder="Enter Content"></textarea>
                                      <div v-if="$page.errors.content" class="text-red-500">{{ $page.errors.content[0] }}</div>
                                  </div>
                            </div>
                          </div>
