    ...
    <div class="container pt-lg-5 pt-md-4">
                    ...
                    <div class="col-lg-5 col-md-6 item">
                        <div class="card">
                            <div class="card-header p-0 position-relative">
                                <a href="#blog-single">
                                    <img class="card-img-bottom d-block radius-image" src="{{asset('theme/assets/images/b1.jpg')}}" alt="Card image cap">
                                </a>
                            </div>
                    ...
                    <div class="col-lg-7 col-md-6 mt-md-0 mt-5">
                        <div class="list-view list-view1">
                            <div class="grids5-info">
                                <a href="#blog-single" class="d-block zoom"><img src="{{asset('theme/assets/images/1.jpg')}}" alt=""
                            ...
                            <div class="grids5-info mt-5">
                                <a href="#blog-single" class="d-block zoom"><img src="{{asset('theme/assets/images/2.jpg')}}" alt=""
                                        class="img-fluid radius-image news-image"></a>
                                <div class="blog-info align-self">
                            ...
                            <div class="grids5-info mt-5">
                                <a href="#blog-single" class="d-block zoom"><img src="{{asset('theme/assets/images/3.jpg')}}" alt=""
                                        class="img-fluid radius-image news-image"></a>
                                <div class="blog-info align-self">
        ...
        <div class="item mt-5 pt-4">
            <div class="row">
                <div class="col-lg-6">
                    <a href="#blog-single">
                        <img class="card-img-bottom d-block radius-image" src="{{asset('theme/assets/images/p3.jpg')}}" alt="Card image cap">
                    </a>
                </div>
        ...
        <div class="item mt-5 pt-lg-5">
            ...
            <div class="row">
                <div class="col-lg-5 col-md-6">
                    <div class="list-view list-view1">
                        <div class="grids5-info">
                            <a href="#blog-single" class="d-block zoom"><img src="{{asset('theme/assets/images/4.jpg')}}" alt=""
                                    class="img-fluid radius-image news-image"></a>
                            <div class="blog-info align-self">
                        ...
                        <div class="grids5-info mt-5">
                            <a href="#blog-single" class="d-block zoom"><img src="{{asset('theme/assets/images/5.jpg')}}" alt=""
                                    class="img-fluid radius-image news-image"></a>
                            <div class="blog-info align-self">
                ...
                <div class="col-lg-5 col-md-6 mt-md-0 mt-5">
                    <div class="list-view list-view1">
                        <div class="grids5-info">
                            <a href="#blog-single" class="d-block zoom"><img src="{{asset('theme/assets/images/6.jpg')}}" alt=""
                                    class="img-fluid radius-image news-image"></a>
                            <div class="blog-info align-self">
                        ...
                        <div class="grids5-info mt-5">
                            <a href="#blog-single" class="d-block zoom"><img src="{{asset('theme/assets/images/7.jpg')}}" alt="" class="img-fluid radius-image news-image"></a>
                            <div class="blog-info align-self">
                ...
                <div class="col-lg-2 col-sm-6 mt-lg-0 mt-5">
                    <div class="ad-img">
                        <a href="#ad-img"><img src="{{asset('theme/assets/images/ad1.jpg')}}" class="img-fluid" alt="ad image" /></a>
                    </div>
                </div>
            ...
            <div class="col-lg-9 most-recent">
                ...
                <div class="list-view ">
                    <div class="grids5-info img-block-mobile">
                        ...
                        <a href="#blog-single" class="d-block zoom mt-md-0 mt-3"><img src="{{asset('theme/assets/images/8.jpg')}}" alt="" class="img-fluid radius-image news-image"></a>
                    </div>
                    ...
                    <div class="grids5-info img-block-mobile mt-5">
                        ...
                        <a href="#blog-single" class="d-block zoom mt-md-0 mt-3"><img src="{{asset('theme/assets/images/9.jpg')}}" alt="" class="img-fluid radius-image news-image"></a>
                    </div>
                    ...
                    <div class="grids5-info img-block-mobile mt-5">
                        ...
                        <a href="#blog-single" class="d-block zoom mt-md-0 mt-3"><img src="{{asset('theme/assets/images/16.jpg')}}" alt="" class="img-fluid radius-image news-image"></a>
                    </div>
                    ...
                    <div class="row most-recent-inner my-5 py-lg-4">
                        <div class="col-md-6">
                            <div class="list-view list-view1">
                                <div class="grids5-info">
                                    <a href="#blog-single" class="d-block zoom"><img src="{{asset('theme/assets/images/10.jpg')}}" alt="" class="img-fluid radius-image news-image"></a>
                                    <div class="blog-info align-self">
                                ...
                                <div class="grids5-info mt-5">
                                    <a href="#blog-single" class="d-block zoom"><img src="{{asset('theme/assets/images/11.jpg')}}" alt="" class="img-fluid radius-image news-image"></a>
                                    <div class="blog-info align-self">
                        ...
                        <div class="col-md-6 mt-md-0 mt-5">
                            <div class="list-view list-view1">
                                <div class="grids5-info">
                                    <a href="#blog-single" class="d-block zoom"><img src="{{asset('theme/assets/images/12.jpg')}}" alt="" class="img-fluid radius-image news-image"></a>
                                    <div class="blog-info align-self">
                                ...
                                <div class="grids5-info mt-5">
                                    <a href="#blog-single" class="d-block zoom"><img src="{{asset('theme/assets/images/13.jpg')}}" alt="" class="img-fluid radius-image news-image"></a>
                                    <div class="blog-info align-self">
                    ...
                    <div class="grids5-info img-block-mobile mt-5">
                        ...
                        <a href="#blog-single" class="d-block zoom mt-md-0 mt-3"><img src="{{asset('theme/assets/images/14.jpg')}}" alt="" class="img-fluid radius-image news-image"></a>
                    </div>
                    ...
                    <div class="grids5-info img-block-mobile mt-5">
                        ...
                        <a href="#blog-single" class="d-block zoom mt-md-0 mt-3"><img src="{{asset('theme/assets/images/15.jpg')}}" alt="" class="img-fluid radius-image news-image"></a>
                    </div>
        ...
        <div class="ad-block text-center mt-5">
            <a href="#url"><img src="{{asset('theme/assets/images/ad.gif')}}" class="img-fluid" alt="ad image" /></a>
        </div>
        <!-- //ad block -->
